...
🛠️ Tech Stack
 ...
 - SQLite - Database สำหรับจัดเก็บข้อมูล
  ...
  ![enter image description here](https://projectsiramet.blob.core.windows.net/lunamanu/diDB.PNG)
...
ผ่าน Authorization token
 ...
 - 3./api/trade/cancel post ยกเลิก order และคือเงินหรือเหรียญ
